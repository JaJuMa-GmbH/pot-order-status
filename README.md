# :bar_chart: Order Status Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/)

<img align="right" width="35%" height="auto" src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/JaJuMa-Order-Status-Power-Toy-For-Magento-2-small.png">  

Order Status Power Toy for Magento 2 by [JaJuMa](https://www.jajuma.de/en) is a Dashboard toy 
displaying quantity of orders, revenue as well as status of orders created within last X hours in your Magento store.
...
This Dashboard Toy displays:
* Quantity of orders in last X hours
* Revenue of orders in last X hours
* Order status of orders in last X hours (Pending/Processing/Complete/Canceled)
...
<td>
    <table>
     <tr>
        <td><b>Order Status Toy</b><br>Dark Mode</td>
        <td><b>Order Status Toy</b><br>Light Mode</td>
     </tr>
     <tr>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Order-Status-Power-Toy-Dark.jpg"></td>
       <td><img src="https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/screenshots/Magento-Order-Status-Power-Toy-Light.jpg"></td>
    </tr>
    </table>
</td>
...
```
composer require jajuma/pot-order-status
```

## Using Order Status Power Toy For Magento

After installing this module:  
Go to   
**JaJuMa -> Power Toys -> Configuration**  
and enable & configure Order Status Toy.  
...
displaying the Order Status Toy.

* [See Manual for more details](https://www.jajuma.de/media/wysiwyg/jajuma-develop/power-toys-magento/manuals/JaJuMa_Order_Status_Power_Toy_Manual_v001.pdf)


## License

The code is licensed under the [MIT License (MIT)](https://github.com/JaJuMa/pot-order-status/blob/master/LICENSE)
